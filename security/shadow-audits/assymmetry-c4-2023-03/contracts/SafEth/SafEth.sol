    ...
    SafEthStorage
{
    ...
    */
    function initialize(                            //@audit-issue no access control
    ...
    */
    function rebalanceToWeights() external onlyOwner {
        ...
        for (uint i = 0; i < derivativeCount; i++) {
            ...
            derivatives[i].deposit{value: ethAmount}();     //  what if the deposits functions failed and it will still emits the event?
        }
        emit Rebalanced();
    }
    ...
    */
    function adjustWeight(
        ...
        weights[_derivativeIndex] = _weight;        // @audit-issue if index is > dederivativeCount will revert
    ...
    */
    function setMaxSlippage(
        ...
        uint _slippage                                      // @audit-issue slippage is owner control
    ) external onlyOwner {
