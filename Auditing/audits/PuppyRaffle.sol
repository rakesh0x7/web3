...
// this is from https://github.com/Cyfrin/3-passwordstore-audit
...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function refund(uint256 playerIndex) public {
        ...
        players[playerIndex] = address(0); //@audit
    ...
    function selectWinner() external {
        ...
        uint256 prizePool = (totalAmountCollected * 80) / 100; //@audit
        ...
        uint256 rarity = uint256(keccak256(abi.encodePacked(msg.sender, block.difficulty))) % 100; !issue
